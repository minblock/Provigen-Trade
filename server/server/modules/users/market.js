...
{
    utils.getJSON('https://pgn.one/api/v1/public/getmarkets', (status, data) => {
        ...
        for (let i=0; i<data.result.length; i++)
        {
            ...
            utils.getJSON('https://pgn.one/api/v1/public/getmarketsummary?market='+BTC+'-'+LYTX+'&period=24', (status2, data2) => {
