...
const SUPPORT_EMAIL = 'support@pgn.one';
const NOREPLY_EMAIL = 'no-reply@pgn.one';
const DOMAIN = 'trade.pgn.one';

const MAILER_NAME = 'Provigen Mailer';
const START_MESSAGE = 'Provigen started!';
const OPENTRADE = "Provigen";
...
exports.recaptcha_pub_key = "6Lc3SLUUAAAAAKGFTszjHH5dt0KhvC7kZf-oCNdD";
